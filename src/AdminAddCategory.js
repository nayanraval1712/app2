...
export default function AdminAddCategory() {
  // creat a 3 veriable to fetch with inpourt like
  ...
  let insertCategory = function (event) {
    ...
    let apiAddress = 'https://www.theeasylearnacademy.com/shop/ws/insert_category.php'
              ...
              <div className="card-body">
                ...
                <form onSubmit={insertCategory}>
                  ...
                  <div className="mb-4">
                    ...
                    <input type="file" name="img" id="img" onChange={(event) => setPhoto(event.target.files[0])} className="form-control" accept="Image/*" />
                  </div>
                  <div className="mb-4">
                    <b>Is this category live?</b>
                    <div className="form-check">
                      <input type="radio" name="islive" id="yes" className="form-check-input" onChange={(event) => setIsLive(event.target.value)} Value={1} />
                      <label className="form-check-lebel" htmlFor="yes">Yes</label>
                    </div>
                    <div className="form-check">
                      <input type="radio" name="islive" id="no" onChange={(event) => setIsLive(event.target.value)} Value={0} className="form-check-input" />
                      <label className="form-check-lebel" htmlFor="no">No</label>
                    </div>
                  </div>
                  <div className="d-flex justify-content-end">
                    <button type="submit" name="submit" className="btn btn-info">Save Catagery </button>&nbsp;
                    <button type="reset" name="reset" className="btn btn-danger">Clear </button>
                  </div>
                </form>
              </div>
            </div>
